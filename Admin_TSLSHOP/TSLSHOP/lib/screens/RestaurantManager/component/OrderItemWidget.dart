...
class OrderItemWidgetState extends State<OrderItemWidget> {
  ...
  Future<void> init() async {
    isShowDeliveryBoyDetail = widget.orderModel!.orderStatus == READY ||
        widget.orderModel!.orderStatus == DELIVERING;

    if (isShowDeliveryBoyDetail) {
      if (widget.orderModel!.deliveryBoyId.validate().isNotEmpty) {
        userService
            .getDeliveryBoyDetails(
                deliveryBoydId: widget.orderModel!.deliveryBoyId)
            .then((value) {
        ...
        children: [
          ...
          isShowDeliveryBoyDetail.validate()
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    // Text(appStore.translate('delivery_boy_details'), style: primaryTextStyle(), overflow: TextOverflow.ellipsis),
                    16.height,
                    // Row(
                    //   children: [
          ...
          Row(
            ...
            children: [
              AppButton(
                ...
                child: Text(widget.buttonTitle.validate(),
              ...
              AppButton(
                ...
                child: Text(widget.secondBtnTitle.validate(),
                    style: primaryTextStyle(color: Colors.white),
                    overflow: TextOverflow.ellipsis),
        ...
        Wrap(
          ...
          children: itemList.map((e) {
            return Container(
              ...
              child: Text('${e.itemName.validate()} X ${e.qty}',
