...
import 'package:food_delivery_admin/screens/Admin/components/UserWidget.dart';
...
class UserFragmentState extends State<UserFragment> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(
          widget.role.validate() == ''
              ? appStore.translate('all_user')
              : widget.role.validate(),
          showBack: false,
          elevation: 0),
            ...
            return SingleChildScrollView(
              ...
              child: LayoutBuilder(builder: (context, constrain) {
                return Wrap(
                  children: snap.data!
                      .map(
                          (e) => UserWidget(data: e, width: constrain.maxWidth))
                      .toList(),
                );
              }),
            );
      ...
      floatingActionButton: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            4.width,
            Text(appStore.translate('add_user'),
