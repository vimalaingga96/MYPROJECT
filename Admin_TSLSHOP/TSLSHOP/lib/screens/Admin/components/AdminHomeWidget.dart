...
import 'package:food_delivery_admin/screens/Admin/components/AdminCounterWidgets.dart';
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(appStore.translate('recent_user'), style: boldTextStyle()).paddingLeft(8),
                      Divider(),
                                ...
                                return Row(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        4.height,
                                        Text(snap.data![i].name.validate(), style: boldTextStyle(size: 12)),
                                        4.height,
                                        Text('${data.email.validate()}', style: secondaryTextStyle(size: 12), overflow: TextOverflow.ellipsis),
                                        4.height,
                                        Row(
                                          crossAxisAlignment: CrossAxisAlignment.center,
                                          children: [
                                            Text('${getUserRoleText(data.role.validate())}', style: boldTextStyle(size: 12)),
                                            4.width,
                                            Text(data.type != 1 ? appStore.translate('pending') : appStore.translate('approved'), style: boldTextStyle(color: data.type != 1 ? Colors.amber : Colors.green))
                ...
                Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(appStore.translate('recent_order'), style: boldTextStyle()).paddingLeft(24),
                      Divider(),
                      StreamBuilder<List<OrderModel>>(
                        stream: orderService.getOrders(orderStatus: [NEW, COOKING, ASSIGNED, READY, DELIVERING, COMPLETED], isDash: true),
                        builder: (_, snap) {
                          if (snap.hasData) {
                            return Container(
                              width: context.width(),
                              child: SingleChildScrollView(
                                ...
                                child: DataTable(
                                  columns: [
                                    ...
                                    DataColumn(label: Text(OrderTableKey.restaurantName, style: boldTextStyle())),
                                  ],
                                  rows: snap.data!.map((e) {
                                    return DataRow(
                                      cells: [
                                        ...
                                        DataCell(Text(e.restaurantName.validate(), style: primaryTextStyle())),
                                      ],
                                    );
                                  }).toList(),
                                ),
