...
class _CategoryItemComponentState extends State<CategoryItemComponent> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      RestaurantByCategoryScreen(catName: widget.category!.categoryName.validate()).launch(context);
    }, highlightColor: appStore.isDarkMode ? scaffoldColorDark : context.cardColor).paddingLeft(16);
  }
}
