          ...
          child: Column(
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    AppTextField(
                      ...
                      decoration: labelInputDecoration(labelText: appStore.translate('address')),
                    ...
                    AppTextField(
                      ...
                      decoration: labelInputDecoration(labelText: appStore.translate('hint_address_other')),
                      cursorColor: colorPrimary,
                    ),
                  ],
                ),
              ...
              AppButton(
                width: context.width(),
                color: colorPrimary,
                child: Text(appStore.translate('save'), style: boldTextStyle(size: 14, color: Colors.white)),
                onTap: () {
                  validate();
                },
              )
